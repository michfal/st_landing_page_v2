    ...
    <section id="structure" className={styles.structure}>
      ...
      <div className={styles.structure__oval_headers}>
        <Fade left duration={dur}>
          <OvalHeader headerText="36 spotkań po 60 minut" color="green" />
        </Fade>
        <h3
          className={clsx(
            styles.structure__conjunction,
            "txt_gray",
            "txt_gray--header"
          )}
        >
        ...
        <Fade right duration={dur}>
          <OvalHeader headerText="18 spotkań po 120 minut" color="blue" />
        </Fade>
      </div>
      ...
      {scrSize === "large" && (
        <Blob position={"structure_left"} color={"violet"} />
      )}
      {scrSize === "large" && (
        <Blob position={"structure_right"} color={"violet"} />
      )}
