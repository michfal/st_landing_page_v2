    ...
    return (
        <section id="contest" className="contest">
            ...
            <StaticImage 
                ...
                quality="100"
            />
            {(scrSize === 'medium' || scrSize === 'large') ? <Blob position={"blob_position-contest1"} color={"blob_fill-light_green"}/>: null}
            {(scrSize === 'medium' || scrSize === 'large') ? <Blob position={"blob_position-contest2"} color={"blob_fill-light_green"}/>: null}
        </section>
    )
}
